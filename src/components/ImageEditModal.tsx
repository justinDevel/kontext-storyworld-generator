  ...
  return (
    <Modal open={isOpen} onOpenChange={onClose}>
      <ModalContent className={`max-w-4xl ${darkMode ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border-gray-200'
        ...
        <ModalHeader>
          <ModalTitle className={`text-2xl font-bold flex items-center gap-3 ${darkMode ? 'text-white' : 'text-gray-900'
            }`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className={`h-64 rounded-xl border-2 border-dashed ${darkMode ? 'border-gray-600 bg-gray-800' : 'border-gray-300 bg-gray-50'
                    ...
                    {isEditing ? (
                      ...
                      <div className="text-center">
                        <Sparkles className={`w-12 h-12 mx-auto mb-3 ${darkMode ? 'text-gray-500' : 'text-gray-400'
                          }`} />
                        <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className={`text-sm px-3 py-1 rounded-full ${tokenCount > 512
                ...
                <div className="relative">
                  <textarea
                    ...
                    className={`w-full min-h-[120px] p-4 rounded-lg border resize-none ${darkMode
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {examplePrompts.map((example, index) => (
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className={`text-left p-3 rounded-lg border text-sm transition-colors ${darkMode
